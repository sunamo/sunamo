...
/// <summary>
/// To working must be in running assembly included PresentationCore.dll
/// </summary>
public class ClipboardHelper
    ...
    {
        // TODO: Rename SetLines to SetList
        SetList(lines);
    }
    ...
    public static void ChangeContent(Func<string, string> stripAllTags)
    {
        SetText(stripAllTags.Invoke(GetText()));
    }
}
