...
namespace UniversalYouTubeExtractor
{
    ...
    {
        /// <summary>
        /// Doporučuji dát přímo do třídy na stahování
        /// </summary>
        /// <param name="cipher"></param>
        /// <param name="cipherVersion"></param>
        /// <returns></returns>
        public async static Task<string> DecipherWithVersion(string cipher, string cipherVersion)
        {
            ...
            string js = await NetHelper.GetResponseTextOrSe(jsUrl, NetHelper.GET, null);
        ...
        /// <summary>
        /// Podle prvního písmena v A2 použije danou operaci
        /// </summary>
        /// <param name="cipher"></param>
        /// <param name="op"></param>
        /// <returns></returns>
        ...
        {
            string vr = operations.Split(new[] { " " }, StringSplitOptions.RemoveEmptyEntries)
        ...
        /// <summary>
        /// Přehodí znak na indexu s znakem na A2 v A1
        /// </summary>
        /// <param name="cipher"></param>
