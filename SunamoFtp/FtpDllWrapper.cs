...
namespace SunamoFtp
{
    public class FtpDllWrapper : FtpBaseNew
    {
        ...
        {
            ConsoleLogger.WriteLine("Actual dir:", Client.GetCurrentFolder());
        }

        public override void DebugAllEntries()
        {
            ConsoleLogger.WriteLine("All file entries:");
            Client.GetList().ForEach(d => ConsoleLogger.WriteLine(d.Name));
