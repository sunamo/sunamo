...
public class XlfKeys
{
	...
	public const string SignInToAddASongTranslationToYourFavorites = "SignInToAddASongTranslationToYourFavorites" ; 
	...
	public const string ADataTypeGoogleplusIdGoogleRunatServerClassPrettySocialFaFaGooglePlusAADataTypeTwitterIdTwitterRunatServerDataViaSunamoClassPrettySocialFaFaTwitterAADataTypeFacebookIdFacebookRunatServerClassPrettySocialFaFaFacebookA = "ADataTypeGoogleplusIdGoogleRunatServerClassPrettySocialFaFaGooglePlusAADataTypeTwitterIdTwitterRunatServerDataViaSunamoClassPrettySocialFaFaTwitterAADataTypeFacebookIdFacebookRunatServerClassPrettySocialFaFaFacebookA" ; 
	...
	public const string RLDidnTFindYourFavoriteVideoOrTextOnThisSiteRLDidnTFindYourFavoriteVideoOrTextOnThisSiteAHrefAddSongAddItRLAddItRLAddItRLAddItA = "RLDidnTFindYourFavoriteVideoOrTextOnThisSiteRLDidnTFindYourFavoriteVideoOrTextOnThisSiteAHrefAddSongAddItRLAddItRLAddItRLAddItA" ; 
    ...
    public const string xFasterThanPlane = "xFasterThanPlane";

    public const string xSlowerThanPlane = "xSlowerThanPlane";

    public const string IsApproximatelyTheSameAsPlane = "IsApproximatelyTheSameAsPlane";
    ...
    public const string YouAreNotLoggedInOrHaveNoRightToPerformTheseOperations = "YouAreNotLoggedInOrHaveNoRightToPerformTheseOperations";
    ...
    public const string GeoCachingHelperDateToStringCacheDateAdded = "GeoCachingHelperDateToStringCacheDateAdded";

    public const string GeoCachingHelperDateToStringCacheHiddenDT = "GeoCachingHelperDateToStringCacheHiddenDT";
    ...
    public const string VersionSpan = "VersionSpan";
    ...
    public const string AnApplicationWithTheSpanTag = "AnApplicationWithTheSpanTag";

    public const string ApplicationWithTag = "ApplicationWithTag";

    public const string Versions = "Versions";

    public const string DescriptionOfApp = "DescriptionOfApp";

    public const string SearchTimestampSpan = "SearchTimestampSpan";

    public const string SearchForSpanText = "SearchForSpanText";

    public const string SpanTagManagementSpan = "SpanTagManagementSpan";

    public const string ManageSpanSoftwareSpanOnWhichItDepends = "ManageSpanSoftwareSpanOnWhichItDepends";
    ...
    public const string ManageImagesAppSpan = "ManageImagesAppSpan";
    ...
    public const string EditaceAplikaceSpan = "EditaceAplikaceSpan";

    public const string AddANewApplication = "AddANewApplication";

    public const string AddANewSpanApplicationSpan = "AddANewSpanApplicationSpan";
    ...
    public const string EitherYouAreNotLoggedInOrHasBeenSelectedAsByoUserID = "EitherYouAreNotLoggedInOrHasBeenSelectedAsByoUserID";
    ...
    public const string SloupecIDAllStringsCommaSeznamNameValue = "SloupecIDAllStringsCommaSeznamNameValue";

    public const string SloupecIDTypAllStringsSpaceSloupecIDAllStringsRbInnerDeleteFromTable = "SloupecIDTypAllStringsSpaceSloupecIDAllStringsRbInnerDeleteFromTable";
    ...
    public const string YouAreNotLoggedInTheApplicationCannotVerifyTheDomainOwner = "YouAreNotLoggedInTheApplicationCannotVerifyTheDomainOwner";
    ...
    public const string YouAreNotLoggedInYouCannotMakeAnyChanges = "YouAreNotLoggedInYouCannotMakeAnyChanges";
    ...
    public const string AddAPage = "AddAPage";
    ...
    public const string ItWasNotObtainedFromTheAddressInformationAboutWhichPollYouWantToEditOrWhetherYouWantToAddANewOne = "ItWasNotObtainedFromTheAddressInformationAboutWhichPollYouWantToEditOrWhetherYouWantToAddANewOne";
    ...
    public const string PollWasSuccessfullyCreatedNowYouCanAddAnswersToIt = "PollWasSuccessfullyCreatedNowYouCanAddAnswersToIt";
    ...
    public const string AddANewDomain = "AddANewDomain";
    ...
    public const string tsWidgetsCommentsSharedJsScript = "tsWidgetsCommentsSharedJsScript";

    public const string jsWidCommentsSharedJsScript = "jsWidCommentsSharedJsScript";

    public const string ScriptsMetroJsScript = "ScriptsMetroJsScript";
    ...
    public const string ContentMetroCss = "ContentMetroCss";
    ...
    public const string YouHaveOpenedANewWindowWithThisPageThePageCannotLogYouOnToThePreviousPageBecauseItDoesNotKnowItsAddress = "YouHaveOpenedANewWindowWithThisPageThePageCannotLogYouOnToThePreviousPageBecauseItDoesNotKnowItsAddress";
    ...
    public const string Lukáš = "Luk\u00E1\u0161";
    ...
    public const string YouAreNotLoggedInCannotJoinOrRemoveFromFanClub = "YouAreNotLoggedInCannotJoinOrRemoveFromFanClub";
    ...
    public const string Pánička = "P\u00E1ni\u010Dka";
    ...
    public const string NěmeckýRex = "N\u011Bmeck\u00FDRex";

    public const string Nebelung = "Nebelung";

    public const string Munchkin = "Munchkin";

    public const string ManskáCat = "Mansk\u00E1Cat";

    public const string MaineCoonCat = "MaineCoonCat";

    public const string KymerskáKočka = "Kymersk\u00E1Ko\u010Dka";
    ...
    public const string YouAreNotLoggedInYouCannotUploadNewPhotos = "YouAreNotLoggedInYouCannotUploadNewPhotos";
    ...
    public const string PhotoGalleryCannotBeDisplayedBecauseYouHaveNotEnteredAnyParametersAndYouAreNotLoggedInAsAValidOwnerToSeeYourMasterAlbum = "PhotoGalleryCannotBeDisplayedBecauseYouHaveNotEnteredAnyParametersAndYouAreNotLoggedInAsAValidOwnerToSeeYourMasterAlbum";
    ...
    public const string YouAreNotLoggedInYouMustLogInBeforeRegisteringAMaster = "YouAreNotLoggedInYouMustLogInBeforeRegisteringAMaster";
    ...
    public const string YouAreNotLoggedInAtAllOrAnErrorOccurredPleaseLogInAgain = "YouAreNotLoggedInAtAllOrAnErrorOccurredPleaseLogInAgain";

    public const string YouAreNotLoggedInAsAValidOwner = "YouAreNotLoggedInAsAValidOwner";
    ...
    public const string TodayCelebratesInCatCalendarB = "TodayCelebratesInCatCalendarB";
    ...
    public const string YouAreNotLoggedInYouCannotSendEmailMessages = "YouAreNotLoggedInYouCannotSendEmailMessages";
    ...
    public const string Pánečky = "P\u00E1ne\u010Dky";
    ...
    public const string YouAreNotLoggedInYouCannotCreateANewBlog = "YouAreNotLoggedInYouCannotCreateANewBlog";
    ...
    public const string errorYouAreNotLoggedIn = "errorYouAreNotLoggedIn";
    ...
    public const string errorYouCannotDeleteImagesYouAreBlockedByTheOwnerOfThisSite = "errorYouCannotDeleteImagesYouAreBlockedByTheOwnerOfThisSite";

    public const string FailedToGetPollIDToWhichYouWantToAddAResponse = "FailedToGetPollIDToWhichYouWantToAddAResponse";
    ...
    public const string YouCannotAddACustomItemToThisPoll = "YouCannotAddACustomItemToThisPoll";
    ...
    public const string errorYouAreTryingToAddANewAnswerToAPollThatIsNotYours = "errorYouAreTryingToAddANewAnswerToAPollThatIsNotYours";
    ...
    public const string AddANewPage = "AddANewPage";

    public const string AddANewDiscussion = "AddANewDiscussion";
    ...
    public const string ČeskýTěšín = "\u010Cesk\u00FDT\u011B\u0161\u00EDn";
    ...
    public const string AddAIfTheSongIsOriginallyInCzechIgnoreThisMessageTheWebsiteDoesNotDistinguishBetweenForeignCzechAndInstrumentalSongs = "AddAIfTheSongIsOriginallyInCzechIgnoreThisMessageTheWebsiteDoesNotDistinguishBetweenForeignCzechAndInstrumentalSongs";
    ...
    public const string AddAIfTheSongIsOnlyInstrumentalIgnoreThisMessageTheWebsiteDoesNotDistinguishBetweenForeignCzechAndInstrumentalSongs = "AddAIfTheSongIsOnlyInstrumentalIgnoreThisMessageTheWebsiteDoesNotDistinguishBetweenForeignCzechAndInstrumentalSongs";
    ...
    public const string SomeOfYourFavoriteLyrics = "SomeOfYourFavoriteLyrics";
    ...
    public const string ThereSNothingForYouYouDonTWantToAddANewYTVideoOrEditAnExistingOneItIsAlsoPossibleThatTheVideoDoesNotBelongToYou = "ThereSNothingForYouYouDonTWantToAddANewYTVideoOrEditAnExistingOneItIsAlsoPossibleThatTheVideoDoesNotBelongToYou";

    public const string YouAreNotLoggedInYouCannotEditYTVideo = "YouAreNotLoggedInYouCannotEditYTVideo";
    ...
    public const string PageB = "PageB";
    ...
    public const string ThisVideoAlreadyHadAnotherSongInOurDatabaseIfYouThinkItStillBelongsHereSendMeItsYTCodeToRadekJancikSunamoCz = "ThisVideoAlreadyHadAnotherSongInOurDatabaseIfYouThinkItStillBelongsHereSendMeItsYTCodeToRadekJancikSunamoCz";
    ...
    public const string ASongOfTheSameNameAlreadyExistsInTheDatabaseAndYouCanFindItAHref = "ASongOfTheSameNameAlreadyExistsInTheDatabaseAndYouCanFindItAHref";
    ...
    public const string AddANewSong = "AddANewSong";
    ...
    public const string chầuVăn = "ch\u1EA7uV\u0103n";
    ...
    public const string caTrù = "caTr\u00F9";
    ...
    public const string NewGoogleMapsPolyline = "NewGoogleMapsPolyline";

    public const string NewGoogleMapsLatLng = "NewGoogleMapsLatLng";
    ...
    public const string GenesisGenGenesisGenMIMMojIMojMojzisMojzIMojzIMojzis = "GenesisGenGenesisGenMIMMojIMojMojzisMojzIMojzIMojzis";
    ...
    public const string IApps = "IApps";
