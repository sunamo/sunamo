...
namespace sunamo.Values
{
    public partial class Consts
    {
        ...
        /// <summary>
        /// Dont use separately, but always with MakeUncLongPath. By this is possible avoiding append more prefixes on same path
        /// </summary>
        ...
        public static readonly List<string> BasicImageExtensions = CA.ToListString(AllExtensions.png, AllExtensions.gif, AllExtensions.jpeg, AllExtensions.jpg, AllExtensions.bmp);
    }
}
