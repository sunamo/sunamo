...
public static class SessionManager
{
    ...
    {
        ////DebugLogger.Write("Přihlašuji uživatele " + login + " se sc " + sc);
    ...
    {
        ////DebugLogger.Write("Přihlašuji uživatele dpo objektu HttpContext " + login + " se sc " + sc);
        SaveNewSessionIDToSession(userId, page.Session.SessionID, sc);
        //regenerateId();
        page.Session.Add("login", login);
        page.Session.Add("userId", userId);
    ...
    {
        ////DebugLogger.Write("Odhlašuji uživatele " + page.Session["login"] + " se sc " + page.Session["sc"]);
