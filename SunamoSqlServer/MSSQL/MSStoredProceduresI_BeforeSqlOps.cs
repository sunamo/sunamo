...
/// 
/// </summary>
public partial class MSStoredProceduresIBase_BeforeSqlOps : SqlServerHelper
{
    public static PpkOnDrive loggedCommands = null;

    static MSStoredProceduresIBase_BeforeSqlOps()
    {
    ...
    public MSStoredProceduresIBase_BeforeSqlOps()
    {
    ...
    {
        return SelectDataTableLastRows(tableName, limit, "*", sloupecID, abc);
    }
    ...
    public bool UpdateSwitchBool(string tablename, string updateColumn, string idColumn, object idValue)
    {
        ...
        Update(tablename, updateColumn, vr, idColumn, idValue);
        return vr;
    }
