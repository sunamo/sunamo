...
public class SunamoGridViewRow
{
    ...
    public string ToString(int actualRow, List<String[]> _dataBinding)
    {
        ...
        if (alternateBG)
        {
            hg.WriteTagWithAttrs("tr", "class", "sedePozadi", "id", "tr" + actualRow,"style", "height: " + minimalniSirkaRadku + AllStrings.sc);
        }
        else
        {
            hg.WriteTagWith2Attrs("tr", "id", "tr" + actualRow, "style", "height: " + minimalniSirkaRadku + AllStrings.sc);
        }
        // 
