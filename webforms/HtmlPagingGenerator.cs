...
public class HtmlPagingGenerator //: HtmlGenerator
{
        ...
        if (pocetStranek != 0)
        {
            if (cssfw == CssFramework.Metro)
            {
                ...
                if (zobrazitBefore)
                {
                    ...
                    hg.WriteTagWithAttrs("a", "runat", "server", "id", "anchorPrevRapid", "href", "javascript:", "onclick", "preskocNaStranku" + msss + unique + AllStrings.lb + 1 + ");return false;");
                    ...
                    hg.WriteTagWithAttr("div", "class", "item");
                    hg.WriteTagWithAttrs("a", "runat", "server", "id", "anchorPrev", "href", "javascript:", "onclick", "preskocNaStranku" + msss + unique + AllStrings.lb + to + ");return false;");
                ...
                if (zobrazitNext)
                {
                    ...
                    hg.WriteTagWithAttr("div", "class", "item");
                    hg.WriteTagWithAttrs("a", "runat", "server", "id", "anchorNext", "href", "javascript:", "onclick", "preskocNaStranku" + msss + unique + AllStrings.lb + (aktStrana + 1).ToString() + ");return false;");
                    hg.WriteRaw(textNext);
                    hg.TerminateTag("a");
                    hg.TerminateTag("div");
                    //hg.WriteRaw("&nbsp;&nbsp;");
                    hg.WriteTagWithAttr("div", "class", "item");
                    hg.WriteTagWithAttrs("a", "runat", "server", "id", "anchorRapid", "href", "javascript:", "onclick", "preskocNaStranku" + msss + unique + AllStrings.lb + pocetStranek + ");return false;");
    ...
    private static int AppendAnchor( HtmlGenerator hg, bool klikaci, int item, string msss, string unique, CssFramework cssfw)
    {
        if (cssfw == CssFramework.Materialize)
        {
            ...
            if (klikaci)
            {
                hg.WriteTagWithAttrs("a", "href", "javascript:", "onclick", "preskocNaStranku" + msss + unique + AllStrings.lb + item + ");return false;");
            }
            else
            {
        ...
        else if (cssfw == CssFramework.Metro)
        {
            ...
            if (klikaci)
            {
                hg.WriteTagWithAttrs("a", "href", "javascript:", "onclick", "preskocNaStranku" + msss + unique + AllStrings.lb + item + ");return false;", "class", "strankovani");
            }
            else
            {
                //hg.WriteTagWithAttr("span", "class", "strankovani");
