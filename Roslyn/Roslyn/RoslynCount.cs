...
namespace Roslyn
{
    public class RoslynCount 
    {
        ...
        public void ThrowException()
        {
            ...
            //// Members
            //ThrowExceptions.ElementWasntRemoved(Exc.GetStackTrace(),type, methodName, "removing class members", before, after);
            //// Methods
            //ThrowExceptions.ElementWasntRemoved(Exc.GetStackTrace(),type, methodName, "removing class methods", before2, after2);
        }
    }
}