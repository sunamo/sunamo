...
static class RHSQLite
{
    ...
    internal static bool IsNullOrWhiteSpaceFieldInsertedRows(object o, string vstup, string nazev)
    {
        Type t = o.GetType();
        FieldInfo fi = t.GetField(nazev);
    ...
    internal static bool IsNullOrWhiteSpaceFieldChangedRows(object o, string vstup, string nazev)
    {
        Type t = o.GetType();
        FieldInfo fi = t.GetField(nazev);
        string s = fi.GetValue(o).ToString();
